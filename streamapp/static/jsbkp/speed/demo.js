...
buttonRandom.addEventListener('change', e => {
    speed = Math.random();
...
ctrfblks= 1;
trfblks = document.querySelector("#speed");
$('#speed').val(ctrfblks)
let trfblkStartValues = 0;
speeds = 80;
let progs = setInterval(()=>{
    
   
   if(trfblkStartValues < 1){
    trfblkStartValues=trfblkStartValues + 0.005;
    var sv= $('speed').val();
    speed = trfblkStartValues
     redraw();
   }
